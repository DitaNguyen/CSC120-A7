...
I struggled with "Type Mismatch" errors early on. I tried using String for names when the HouseRequirements interface strictly demanded Student objects. Learning that Java treats these as entirely different types was a big learning moment for me.
